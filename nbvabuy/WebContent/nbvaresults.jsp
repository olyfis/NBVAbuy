...
<%
	...
	if (at != null) {
		...
		if (at.equals("100")) {
			...
			String redirectURL = "http://" + hostname2  + ":8181/nbvabuy/nbva.jsp";
			response.sendRedirect(redirectURL);
		...
		String redirectURL = "http://" + hostname2  + ":8181/nbvabuy/createdispfile.jsp";
		response.sendRedirect(redirectURL);
			...
			//out.println("ID:" + id + "--");
			String redirectURL = "http://" + hostname2  + ":8181/nbvabuy/nbva?id=" + id;
			response.sendRedirect(redirectURL);
		} else if (at.equals("150")) {
			...
			String id = request.getParameter("id");
			//out.println("ID:" + id + "--");
			String redirectURL = "http://" + hostname  + ":8181/nbvabuy/nbva?id=" + id;
			response.sendRedirect(redirectURL);
